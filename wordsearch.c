...
void printAnswer(size_t size); /* Prints the solved word search */
void findWord(char *word, size_t size); /* Finds the word in the word search */
int checkSides(char *word, size_t size, size_t row, size_t column, size_t position, int deltaRow, int deltaColumn); /* Checks for word going different directions */
